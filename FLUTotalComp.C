...
double ratio = x1/y1;
FILE * fp1 = fopen("DepolTotalQ2.txt", "r"); // epsilon factor

FILE *fp2 = fopen("ALUTotalQ2.txt", "r"); //A_LU

FILE *fp4 = fopen("FLU_Q2_Tab.txt", "w"); //F_LU
int n=0;
...
fscanf(fp1, "%lf %lf %lf", &y1, &erry1, &x1); //no error calculated for pT depol 
...
////////////////////////////////////////////////////////////////////////////////
FILE *fp3 = fopen("ALUTotalQ2.txt", "r");
int o = 0;
...
h3->Draw("AP");
h3->GetXaxis()->SetRangeUser(0.0, 8.0);     //xF (-0.8, 0.6); Q2 (0.0, 6.0); pT (0.0, 1.3)
h3->GetYaxis()->SetRangeUser(-0.05, 0.005); //xF (-0.04, 0.04); Q2 (-0.05, 0.005); pT_TFR (-0.09, 0.0); pT_CFR (-0.02, 0.17)
