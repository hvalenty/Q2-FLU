...
double ratio = x1/y1;
FILE * fp1 = fopen("DepolTotalQ2.txt", "r");

FILE *fp2 = fopen("ALUTotalQ2.txt", "r");

//FILE *fp4 = fopen("FLU_Q2_Tab.txt", "w"); don't need for single plot b/c made with FLUTotalComp.C
int n=0;
...
fscanf(fp1, "%lf %lf %lf", &y1, &erry1, &x1); //no error calculated for pT depol (rm erry1 for Q2, sike just made it)
